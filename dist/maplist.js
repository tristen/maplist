...
module.exports = {
    // Test if a string is base64 encoded via http://goo.gl/blTNX
    isEncoded: /^([A-Za-z0-9+/]{4})*([A-Za-z0-9+/]{4}|[A-Za-z0-9+/]{3}=|[A-Za-z0-9+/]{2}==)$/
}
...
},{"./src/icons.js":1,"./src/utils.js":2,"./src/markers.geojson":3,"underscore":5,"js-base64":6,"d3":7,"hoverintent":8}],5:[function(require,module,exports){
...
},{"./d3":10}],11:[function(require,module,exports){
(function(){// UTILITY
...
},{"util":12,"buffer":9}],10:[function(require,module,exports){
d3 = function() {
  var d3 = {
    version: "3.1.9"
  };
